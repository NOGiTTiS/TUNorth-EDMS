...
export default function DashboardLayout({
  ...
  const menuItems = [
    ...
    ...(['admin_central', 'director'].includes(user.role) ? [
        ...
        ...(user.role === 'admin_central' ? [{ name: 'รายงานสมุดทะเบียนรับ', icon: BookMarked, href: '/dashboard/reports/logbook' }] : [])
    ] : []),

    // - รายงานฝ่าย (ธุรการฝ่าย + รองฯ)
    ...(['admin_dept', 'deputy'].includes(user.role) ? [
        { name: 'รายงานฝ่าย', icon: BarChartBig, href: '/dashboard/reports/department' }
    ] : []),
